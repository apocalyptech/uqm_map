...
class SystemTests(unittest.TestCase):
    ...
    def test_apply_filters_empty_filters(self):
        ...
        self.assertEqual(self.s.min_agg.value(), 52)
        self.assertEqual(self.s.min_agg_full.value(), 52)
        self.assertEqual(self.s.min_agg.base, 4)
        self.assertEqual(self.s.min_agg_full.base, 4)
        self.assertEqual(self.s.min_agg.radioactive, 5)
        self.assertEqual(self.s.min_agg_full.radioactive, 5)
    ...
    def test_apply_filters_dont_highlight(self):
        ...
        self.assertEqual(self.s.min_agg.value(), 43)
        self.assertEqual(self.s.min_agg_full.value(), 43)
    ...
    def test_apply_filters_no_planet_matches(self):
        ...
        self.assertEqual(self.s.highlight, True)
        self.assertEqual(self.s.min_agg.value(), 0)
        self.assertEqual(self.s.min_agg_full.value(), 43)
    ...
    def test_apply_filters_one_planet_matches(self):
        ...
        self.s.apply_filters(Filter(), f)
        self.assertEqual(self.s.highlight, True)
        self.assertEqual(self.s.min_agg.value(), 9)
        self.assertEqual(self.s.min_agg_full.value(), 52)
        self.assertEqual(self.s.min_agg.base, 3)
        self.assertEqual(self.s.min_agg_full.base, 4)
        self.assertEqual(self.s.min_agg.radioactive, 0)
        self.assertEqual(self.s.min_agg_full.radioactive, 5)
